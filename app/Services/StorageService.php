...
class StorageService
{
    ...
    /**
     * Resolve a relative storage path into a secure media route URL.
     * External absolute URLs (e.g. seeders/mock) are passed through as-is.
     */
    ...
    public function temporaryUrl(string $path, int $expirationMinutes = 60): string
    {
        try {
            ...
            return self::url($path) ?? Storage::disk($this->disk)->url($path);
        }
    }
