...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.pgsql.pool.max_connections' => 'integer',
            'database.connections.pgsql.pool.min_connections' => 'integer',
            'database.connections.pgsql.pool.max_lifetime' => 'integer',
            ...
            'filesystems.links./home/dev/projects/smauiiyk/smauii-core/public/storage' => 'string',
...
'database.connections.pgsql.sslmode','database.connections.pgsql.pool.max_connections','database.connections.pgsql.pool.min_connections','database.connections.pgsql.pool.max_lifetime','database.connections.sqlsrv.driver',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/dev/projects/smauiiyk/smauii-core/public/storage','inertia.ssr.enabled','inertia.ssr.runtime',
...
'tinker.commands','tinker.alias','tinker.dont_alias','tinker.trust_project','dompdf.show_warnings',
...
'sanctum.csrf-cookie','telescope','api.login','api.logout','api.user','api.refresh',
'api.sessions','api.sessions.revoke','students.index','students.store','students.show',
'students.update','students.destroy','teachers.index','teachers.store','teachers.show',
'teachers.update','teachers.destroy','classes.index','classes.store','classes.show',
'classes.update','classes.destroy','guardians.index','guardians.store','guardians.show',
'guardians.update','guardians.destroy','api.attendances.index','api.attendances.today','api.attendances.check-in',
'api.attendances.history','api.attendances.stats','api.leave-requests.index','api.leave-requests.store','api.leave-requests.show',
'api.leave-requests.verify','api.academic-calendars.index','api.academic-calendars.all','api.academic-calendars.store','api.academic-calendars.show',
'api.academic-calendars.update','api.academic-calendars.destroy','api.attendance-time-settings.index','api.attendance-time-settings.bulk-update','api.duty-schedules.index',
'api.duty-schedules.store','api.duty-schedules.show','api.duty-schedules.update','api.duty-schedules.destroy','api.import.students',
'api.import.teachers','login','login.authenticate',
'logout','dashboard','admin.master-data','admin.master-data.students.store','admin.master-data.students.update',
'admin.master-data.students.destroy','admin.master-data.students.toggle','admin.master-data.teachers','admin.master-data.teachers.store','admin.master-data.teachers.update',
'admin.master-data.teachers.destroy','admin.master-data.classes','admin.master-data.classes.store','admin.master-data.classes.update','admin.master-data.classes.destroy',
'admin.master-data.guardians','admin.master-data.guardians.store','admin.master-data.guardians.update','admin.master-data.guardians.destroy','admin.monitoring',
'admin.leave-verification','admin.leave-verification.approve','admin.leave-verification.reject','admin.leave-requests','admin.classes',
'admin.classes.store','admin.classes.update','admin.classes.destroy','admin.monthly-recap','admin.daily-recap',
'admin.class-enrolment','admin.class-enrolment.assign','admin.class-enrolment.remove','admin.duty-schedules','admin.duty-schedules.store',
'admin.duty-schedules.update','admin.duty-schedules.destroy','admin.settings','admin.settings.time-settings','admin.settings.holidays.store',
'admin.settings.holidays.delete','admin.export.students','admin.export.teachers','admin.export.daily-recap','admin.export.monthly-recap',
'admin.export.daily-recap-pdf','admin.export.monthly-recap-pdf','admin.attendance.correction','admin.attendance.correction.store','admin.attendance.correction.destroy',
'student.dashboard','student.live-attendance','student.live-attendance.checkin','student.history','teacher.duty',
'teacher.homeroom','guardian.dashboard','guardian.leave-application','guardian.leave-application.store',
...
'errors.minimal','exports.daily-recap','exports.monthly-recap','notifications::email','pagination::bootstrap-3',
...
'pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','vendor.mail.html.button','vendor.mail.html.footer',
...
'vendor.pagination.simple-bootstrap-4','vendor.pagination.simple-bootstrap-5','vendor.pagination.simple-tailwind','vendor.pagination.tailwind','laravel-exceptions-renderer::components.badge',
...
'SESSION_DOMAIN','BROADCAST_CONNECTION','FILESYSTEM_DISK','QUEUE_CONNECTION','PUSHER_APP_ID',
'PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_APP_CLUSTER','VITE_PUSHER_APP_KEY','VITE_PUSHER_APP_CLUSTER',
...
'WWWGROUP','WWWUSER','MAIL_ENCRYPTION',);
