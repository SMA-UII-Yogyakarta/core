...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./var/www/html/public/storage','inertia.ssr.enabled','inertia.ssr.runtime',
...
'telescope.allowed_emails','tinker.commands','tinker.alias','tinker.dont_alias','tinker.trust_project',
...
'dompdf.options.enable_html5_parser','structure-discoverer.ignored_files','structure-discoverer.structure_scout_directories','structure-discoverer.cache.driver','structure-discoverer.cache.store',
...
'signed','throttle','verified','role','teacher.type',
'authorize',);
        registerArgumentsSet('routes', 
'sanctum.csrf-cookie','telescope','api.login','api.logout','api.user','api.refresh',
'api.sessions','api.sessions.revoke','api.academic-calendars.index','api.academic-calendars.all','api.academic-calendars.show',
'students.index','students.store','students.show','students.update','students.destroy',
'teachers.index','teachers.store','teachers.show','teachers.update','teachers.destroy',
'classes.index','classes.store','classes.show','classes.update','classes.destroy',
'guardians.index','guardians.store','guardians.show','guardians.update','guardians.destroy',
'api.academic-calendars.store','api.academic-calendars.update','api.academic-calendars.destroy','api.attendance-time-settings.index','api.attendance-time-settings.bulk-update',
'api.duty-schedules.store','api.duty-schedules.update','api.duty-schedules.destroy','api.import.students','api.import.teachers',
'api.attendances.index','api.duty-schedules.index','api.duty-schedules.show','api.leave-requests.verify','api.leave-requests.index',
'api.leave-requests.show','api.attendances.today','api.attendances.check-in','api.attendances.history','api.attendances.stats',
'api.leave-requests.store','login','login.authenticate',
'health','logout','overview','dashboard','monitoring',
'master-data','master-data.store','master-data.students.update','master-data.students.bulk-destroy','master-data.students.toggle','master-data.teachers.store','master-data.teachers.update','master-data.classes.store',
'master-data.classes.update','master-data.guardians.store','master-data.guardians.update','master-data.students.destroy',
'master-data.teachers.destroy','master-data.classes.destroy','master-data.guardians.destroy','class-enrolment','class-enrolment.assign',
'class-enrolment.remove','settings','settings.time-settings','settings.holidays','settings.holidays.destroy',
'leave-requests.index','leave-requests.verification','leave-requests.show','leave-requests.approve','leave-requests.reject',
'reports.daily','reports.monthly','reports.semester','export.index','export.students',
'export.teachers','export.daily-recap','export.monthly-recap','export.semester-recap','export.daily-recap-pdf',
'export.monthly-recap-pdf','export.semester-recap-pdf','attendance-correction','attendance-correction.store','attendance-correction.destroy',
'teacher.duty','teacher.homeroom','guardian.dashboard','guardian.leave-application','guardian.leave-application.store',
'guardian.history','student.dashboard','student.attendance','student.attendance.check-in','student.history',
'notifications','notifications.store','notifications.read.all','notifications.read','notifications.destroy',
'profile','profile.update','profile.sessions.revoke','storage.local',
'storage.local.upload',);
        registerArgumentsSet('views', 
'app','errors.401','errors.402','errors.403','errors.404',
'errors.419','errors.429','errors.500','errors.503','errors.layout',
'errors.minimal','exports.daily-recap','exports.monthly-recap','exports.semester-recap','notifications::email',
...
'pagination::simple-bootstrap-4','pagination::simple-bootstrap-5','pagination::simple-tailwind','pagination::tailwind','vendor.mail.html.button',
...
'vendor.notifications.email','vendor.pagination.bootstrap-3','vendor.pagination.bootstrap-4','vendor.pagination.bootstrap-5','vendor.pagination.semantic-ui',
...
'APP_PORT','PGSQL_PORT','REDIS_PORT','MAILPIT_SMTP_PORT','MAILPIT_UI_PORT',
