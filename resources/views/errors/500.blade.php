...
<head>
    ...
    <title>500 — {{ __('Kesalahan Server') }} | SMA UII Yogyakarta</title>
...
<body class="antialiased bg-background font-inter">
    <div class="min-h-screen flex items-center justify-center p-6">
        <div class="text-center max-w-md">
            ...
            <h1 class="text-[48px] font-bold text-primary leading-none mb-2">500</h1>
            <h2 class="text-[18px] font-bold text-text-primary mb-2">{{ __('Kesalahan Server') }}</h2>
            <p class="text-[14px] text-text-muted mb-8 leading-relaxed">
                Terjadi kesalahan pada server. Tim teknis telah diberitahu.
