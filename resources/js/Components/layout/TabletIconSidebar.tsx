...
export default function TabletIconSidebar({ navSections, activeItemKey }: TabletIconSidebarProps) {
    return (
        <aside className="bg-primary py-4 px-2 flex flex-col items-center gap-3 rounded-none hidden sm:flex lg:hidden w-16 shrink-0 select-none overflow-y-auto overflow-x-hidden no-scrollbar border-r border-white/10 z-20">
            {/* Navigation Icons */}
