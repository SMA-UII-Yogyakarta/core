...
import { FiCalendar, FiCheck, FiUser } from "react-icons/fi";
            ...
            <div className="space-y-2.5">
                ...
                >
                    <div className="flex items-center gap-3">
                        <div
                            className={`p-2 rounded-lg ${activeRole === "homeroom" ? "bg-brand-primary/10" : "bg-surface-hover"}`}
                        >
                            <FiUser
                                size={18}
                                className={activeRole === "homeroom" ? "text-brand-primary" : "text-text-muted"}
                            />
                        </div>
                ...
                >
                    <div className="flex items-center gap-3">
                        <div
                            className={`p-2 rounded-lg ${activeRole === "duty" ? "bg-brand-primary/10" : "bg-surface-hover"}`}
                        >
                            <FiCalendar
                                size={18}
                                className={activeRole === "duty" ? "text-brand-primary" : "text-text-muted"}
                            />
                        </div>
                        <div className="text-left">
