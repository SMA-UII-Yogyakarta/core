...
export default function CommandPalette({ isOpen, onClose }: CommandPaletteProps) {
    ...
    const commands = useMemo<CommandItem[]>(() => {
        const list: CommandItem[] = [
            ...
            {
                id: "nav-operational-settings",
                title: "Buka Atur Waktu & Hari Libur",
                description: "Konfigurasi jam absensi, lokasi geofence, dan hari libur sekolah",
                category: "Navigasi Halaman",
                icon: FiClock,
                action: () => router.visit("/operational-settings"),
                roles: ["admin"],
            },
            {
                id: "nav-system-settings",
                title: "Buka Pengaturan Sistem Core",
                description: "Kelola profil institusi, integrasi API, dan preferensi keamanan backend",
                category: "Navigasi Halaman",
                icon: FiSliders,
