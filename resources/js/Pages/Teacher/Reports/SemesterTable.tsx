...
export default function SemesterTable({ students, summary, chartData, semester, year }: SemesterTableProps) {
    const { t } = useLanguage();

    const semesterLabel = semester === "1" ? `Ganjil ${year}/${year + 1}` : `Genap ${year - 1}/${year}`;
            ...
            {chartPoints.length > 0 && (
                <div className="bg-surface border border-border rounded-xl p-4">
                    <h3 className="text-[14px] font-semibold text-text-primary mb-4">
                        Grafik Kehadiran Bulanan ({semesterLabel})
                    </h3>
                    <AttendanceChart data={chartPoints} type="stacked" height={300} />
                </div>
            )}
            ...
            <div className="bg-surface border border-border rounded-xl overflow-hidden">
                <div className="px-4 py-3 border-b border-border">
                    <h3 className="text-[14px] font-semibold text-text-primary">
                        Data Rekapitulasi Siswa (Semester {semesterLabel})
                    </h3>
                </div>
                                    ...
                                    <div key={s.id} className="px-4 py-3">
                                        ...
                                        <div className="flex gap-4 ml-8 items-center">
                                            ...
                                            <div className="text-center ml-auto">
                                                <p className="text-[16px] font-bold text-text-primary">{rate}%</p>
