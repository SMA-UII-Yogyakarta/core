...
import {
    FiChevronDown, FiX, FiCheck, FiSearch, FiCalendar, FiRefreshCw,
    FiFileText, FiImage, FiMaximize2, FiUser, FiArrowDown, FiClipboard,
    FiSmile, FiClock, FiLoader, FiZoomOut, FiRepeat, FiRotateCcw,
            ...
            {previewImage && (
                ...
                >
                    ...
                    <div className="flex items-center justify-between p-3 md:hidden shrink-0 bg-surface border-b border-border">
                        <h3 className="text-base font-bold text-text-primary">
                            {t("leave-verification.documentPreview")}
                        </h3>
                        <div className="flex items-center gap-2">
                            {rotateLevel % 360 !== 0 && (
                                <button
                                    ...
                                    className="w-11 h-11 flex items-center justify-center rounded-full bg-slate-100 hover:bg-slate-200 text-text-muted hover:text-text-primary transition-colors"
                                >
                    ...
                    {/* Mobile Content: full remaining height */}
